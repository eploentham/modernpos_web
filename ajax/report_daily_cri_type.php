...
if(!empty($_GET["radio1"]) && $_GET["radio1"]==="daily"){
	...
	$sql="Select bil.bill_date, footype.foods_type_name, sum(bild.amount) as amount "
		."From t_bill bil "
		."Left Join t_bill_detail bild on bil.bill_id = bild.bill_id  "
		."Left Join b_foods foo on foo.foods_id = bild.foods_id "
		."Left Join b_foods_type footype on foo.foods_type_id = footype.foods_type_id "
